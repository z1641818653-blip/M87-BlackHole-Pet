###  windows版本下载地址在下面↓
###  mac版本在左上角main切换macos分枝内，暂时没有做官方验证，所以需要自己想办法（99刀验证费我想缴也没办法，运行测试通过了，只是系统不认可）
...
下载页内内置exe版本但是略大，我把Electron装进去打包了，100mb左右，其实本体只有4mb但是需要电脑支持Electron环境，这个不好下载所以看需求选择。
